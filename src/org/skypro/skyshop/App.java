...
public class App {
    ...
    public static void searchEngineDemo(String searchString) {
        ...
        thatStorage.addNewItem(new Article("Гвоздь совсем маленький", "Гвоздь. Болт."));
        thatStorage.addNewItem(new Article("Гвоздь", "Гвоздь одноразрядный"));
        thatStorage.addNewItem(new Article("Гвоздь поменьше (но все равно норм)",
                "Гвоздь - Гвоздь или Гвоздь, Болт - Болт"));
        thatStorage.addNewItem(new Article("Наиболее длинный Гвоздь в названии статьи",
        ...
        System.out.println(">простой поиск по ключу \"" + searchString + "\" с выводом всех объектов");
        if (!thatStorage.searchItem(searchString).isEmpty()) {
            System.out.println(thatStorage.searchItem(searchString));
        }
        System.out.println();

        System.out.println(">поиск наибольшего количества совпадений по вхождению (в т.ч. в содержимом) \"" + searchString + "\"");
        try {
    ...
    public static void productBasketDemo(String searchString) {
        ...
        System.out.println(">вывод всей корзины");
        productBasket.printBasket();
        System.out.println();

        System.out.println(">удаление группы товаров по названию \"" + searchString + "\" из корзины: ");
        ...
        System.out.println(">полная очистка корзины");
